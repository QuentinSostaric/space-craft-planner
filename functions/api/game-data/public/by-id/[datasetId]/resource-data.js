...
export async function onRequestGet(context) {
  ...
  try {
    const match = await getVisibleDatasetChunk(context.request, context.env, datasetId, 'resource-data');
    ...
    return publicApiJsonResponse(
      {
        datasetId,
        resourceInsights: match.chunk?.resourceInsights ?? null,
        materialSources: match.chunk?.materialSources ?? null,
      },
      {
        headers: {
