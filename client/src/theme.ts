...
export const createAppTheme = (mode: ThemeMode) => {
  ...
  return createTheme({
    ...
    typography: {
      ...
      caption: { fontFamily: FONT_MONO, fontSize: TEXT_LABEL, letterSpacing: '0.02em', fontVariantNumeric: 'tabular-nums' },
      overline: { fontFamily: FONT_MONO, fontSize: TEXT_LABEL_SM, letterSpacing: '0.06em', textTransform: 'uppercase', fontVariantNumeric: 'tabular-nums' },
    },
